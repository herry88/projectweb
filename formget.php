                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="radio" class="form-check-input position-static" name="agama" value="islam">Islam
                                        <input type="radio" class="form-check-input  position-static" name="agama" value="kristen">Islam
